...
// 不像官方示例里的 TrackballControls, 它保持向上的方向(Y+ 默认)
//
//    动态观察 - 鼠标左键/触摸: 一个手指的移动
//    缩放-鼠标中键或鼠标滚轮/触摸：两个手指展开或挤压
//    平移-鼠标右键，或鼠标左键+ctrl/meta/Shift键，或箭头键/触摸：两个手指移动
...
THREE.OrbitControls = function (object, domElement) {
  ...
  // 可以推拉多远（仅透视摄影机 PerspectiveCamera）
  this.minDistance = 0;
  this.maxDistance = Infinity;

  // 放大和缩小的距离（仅限于正交摄影机 OrthographicCamera）
  this.minZoom = 0;
  ...
  // 是否自动旋转
  // 如果允许自动旋转，必须在动画循环里去执行controls.update()
  this.autoRotate = true;
  this.autoRotateSpeed = 0.001; // 30 seconds per round when fps is 60
